...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * 
     *               ,-----------------------------------------------.
     *               |F13|F14|F15|F16|F17|F18|F19|F20|F21|F22|F23|Pus|
     *               `-----------------------------------------------' 
     *               ,-----------------------------------------------.
     ...
     * |-------| |-----------------------------------------------------------| ,-----------. |---------------|
     * |Rwd|Ffd| |Shif|  \|  Z|  X|  C|  V|  B|  N|  M|  ,|  ,|  /|Shift     | |Lef|Dow|Rig| |  1|  2|  3|   |
     * |-------| |-----------------------------------------------------------| `-----------' |-----------|Ent|
     * |Cpy|Pas| |Ctrl|    |Alt |          Space              |Alt |    |Ctrl|     |Dow|     |      0|  .|   |
     * `-------' `----'    `---------------------------------------'    `----'     `---'     `---------------'
     */

    KEYMAP(
                     F13, F14, F15, F16, F17, F18, F19, F20, F21, F22, F23, PAUS,
                     F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12,
    ...
    MRWD, MFFD,  LSFT, NO, Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,     RO,  RSFT,  LEFT,DOWN,RGHT,  P1,  P2,  P3,  PENT,
    COPY,PASTE,  LCTL,     LALT,               SPC,                          RALT,     RGUI,       DOWN,       NO,  P0,  PDOT,NO
    ),
